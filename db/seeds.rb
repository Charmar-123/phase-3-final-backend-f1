...
Driver.create(name:"Alexander Albon" , dob:"1996-03-23" ,nationality:"Thai" ,number:"23" ,constructor_id: 10)
Driver.create(name:"Fernando Alonso" , dob:"1981-07-29" ,nationality:"Spanish" ,number:"14" ,constructor_id: 4)
Driver.create(name:"Valtteri Bottas" , dob:"1989-08-28" ,nationality:"Finnish" ,number:"77" ,constructor_id: 1)
Driver.create(name:"Nyck De Vries" , dob:"1995-02-06" ,nationality:"Dutch" ,number:"21" ,constructor_id: 2)
Driver.create(name:"Pierre Gasly" , dob:"1996-02-07" ,nationality:"French" ,number:"10" ,constructor_id: 3)
Driver.create(name:"Lewis Hamilton" , dob:"1985-01-07	" ,nationality:"British" ,number:"44" ,constructor_id: 8)
Driver.create(name:"Nico Hulkenberg" , dob:"1987-08-19" ,nationality:"German" ,number:"27" ,constructor_id: 6)
Driver.create(name:"Charles Leclerc" , dob:"1997-10-16" ,nationality:"Monegasque" ,number:"16" ,constructor_id: 5)
Driver.create(name:"Kevin Magnussen" , dob:"1992-10-05" ,nationality:"Danish" ,number:"20" ,constructor_id: 6)
Driver.create(name:"Lando Norris" , dob:"1999-11-13" ,nationality:"British" ,number:"4" ,constructor_id: 7)
Driver.create(name:"Esteban Ocon" , dob:"1996-09-17" ,nationality:"French" ,number:"31" ,constructor_id: 3)
Driver.create(name:"Sergio Perez" , dob:"1990-01-26" ,nationality:"Mexican" ,number:"11" ,constructor_id: 9)
Driver.create(name:"Oscar Piastri" , dob:"2001-04-06" ,nationality:"Australian" ,number:"81" ,constructor_id: 7)
Driver.create(name:"George Russell" , dob:"1998-02-15" ,nationality:"British" ,number:"63" ,constructor_id: 8)
Driver.create(name:"Carlos Sainz" , dob:"1994-09-01" ,nationality:"Spanish" ,number:"55" ,constructor_id: 5)
Driver.create(name:"Logan Sargeant" , dob:"2000-12-31" ,nationality:"American" ,number:"2" ,constructor_id: 10)
Driver.create(name:"Lance Stroll" , dob:"1998-10-29" ,nationality:"Canadian" ,number:"18" ,constructor_id: 4)
Driver.create(name:"Yuki Tsunoda" , dob:"2000-05-11" ,nationality:"Japanese" ,number:"22" ,constructor_id: 2)
Driver.create(name:"Max Verstappen" , dob:"1997-09-30	" ,nationality:"Dutch" ,number:"33" ,constructor_id: 9)
Driver.create(name:"Zhou Guanyu" , dob:"1999-05-30" ,nationality:"Chinese" ,number:"24" ,constructor_id: 1)
